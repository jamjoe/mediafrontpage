<?php
$wdgtXbmcLibrary = array("name" => "XBMC Library", "type" => "ajax", "block" => "xbmclibrarywrapper", "call" => "widgets/wXBMCLibrary.php?w=l&style=w&a=l", "interval" => 100000, "headerfunction" => "widgetLibraryHeader(\$params);");
$wIndex["wXBMCLibrary"] = $wdgtXbmcLibrary;

$wdgtRecentMovie = array("name" => "Recent Movies", "type" => "ajax", "block" => "recentmoviewrapper", "call" => "widgets/wXBMCLibrary.php?w=rm&style=w&a=rm&c=15", "interval" => 100000, "loader" => "cmdXbmcLibrary('recentmoviewrapper', 'widgets/wXBMCLibrary.php?w=rm&', 'rm', '', '', true);");
$wIndex["wRecentMovies"] = $wdgtRecentMovie;

$wdgtRecentTV = array("name" => "Recent Episodes", "type" => "ajax", "block" => "recenttvwrapper", "call" => "widgets/wXBMCLibrary.php?w=re&style=w&a=re&c=15", "interval" => 100000, "loader" => "cmdXbmcLibrary('recenttvwrapper', 'widgets/wXBMCLibrary.php?w=re&', 're', '', '', true);");
