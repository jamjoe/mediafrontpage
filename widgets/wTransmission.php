...
function widgetTransmission(){
	...
	try{
		...
		echo "<input type='text'  value='".$dl_speed_limit."' id='dllimit' name='dllimit' size='1' /><img src='media/btnDown.png' width='8px' height='20px' style='vertical-align:middle;' />";
		echo "<input type='text'  value='".$ul_speed_limit."' id='ullimit' name='ullimit' size='1' /><img src='media/btnUp.png' width='8px' height='20px' style='vertical-align:middle;' />";
