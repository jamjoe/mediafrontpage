...
$xbmcimgpath = 'http://USER:PASSWORD@localhost:8080/vfs/'; //leave as default if unsure
...
$sickbeardcomingepisodes = 'http://localhost:8081/comingEpisodes/';
$sickbeardurl = "http://localhost:8081";
...
$nzbusername = 'USER';    //username
$nzbapi = 'NZBMatrixAPI';           //api

//enter nzb.su login
$nzbsuapi = 'NZBsAPI';                // find this in http://nzb.su/profile
$nzbsudl = '&i=(ID)&r=(API)';      // find this in http://nzb.su/rss where it says "Add this string to your feed URL to allow NZB downloads without logging in:"

//Choose your default category and website to serch
$preferredSearch = '1';      // Set to 1 for NZBMatrix and 2 for nzb.su
...
$cp_url =  "http://localhost:5000/";		//eg.: http://admin:password@192.168.0.5:5000/

//Trakt info
$trakt_url = "http://trakt.tv/user/USER/widget"; //URL to Widget
...
// enter navigation bar links (Main bar)
$navlink;
$navlink["AWX"] = "http://localhost:8082";
$navlink["XWMM"] = "http://localhost:8082/XWMM/movies/index.html";
$navlink["SubSonic"] = "http://localhost:4040";
$navlink["Sickbeard"] = "http://localhost:8081";
$navlink["Couch Potato"] = "http://localhost:5000";
$navlink["Sabnzbd"] = "http://localhost:8080";

// Submenu bar
// $nalink2 opens links in a new tab
$navlink2["Google"] = "http://www.google.co.uk/";

// $nalink2 opens links in place of MediaFrontPage frame, but keeps the Main bar in place.
$navlink3["XBMC"] = "http://www.xbmc.org/";
...
$drive["Mnt Sata 3"] = "/mnt/Sata3";

// enter rss feeds. Ensure sabnzbd > config > index sites is set. Supports cat, pp, script, priority as per the sabnzbd api.
$rssfeeds["Gugahoi MFP Github"]       = array("url" => "https://github.com/gugahoi/mediafrontpage/commits/master.atom", "type" => "atom");
