...
echo '<br>';
if(extension_loaded('libxml')) { echo "Lib XML found <img src='media/green-tick.png' height='15px'/>";}else{echo "Lib XML NOT found, you will need to change your php.ini <img src='media/red-cross.png' height='15px'/>"; $redirect = false;}echo '<br>';
if(extension_loaded('curl')) { echo "Curl found <img src='media/green-tick.png' height='15px'/>";} else { echo "Curl NOT found, you will need to change your php.ini <img src='media/red-cross.png' height='15px'/>"; $redirect = false;} echo '<br>';
if (file_exists('config.php')){echo "You created config.php, seems like everything is in working order. <img src='media/green-tick.png' height='15px'/>";}
